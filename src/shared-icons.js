...
/*
  Icons needed by the different components, defined here to avoid loading the full collection
  included in https://www.webcomponents.org/element/PolymerElements/iron-icons
*/
...
</iron-iconset-svg><iron-iconset-svg name="maps" size="24">
  <svg>
    <defs>
...
</iron-iconset-svg><iron-iconset-svg name="av" size="24">
  <svg>
    <defs>
...
</iron-iconset-svg><iron-iconset-svg name="social" size="24">
  <svg>
    <defs>
